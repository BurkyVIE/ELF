...
### A B C D E ----                        
         "Bravos", tribble(~Team, ~Abb, ~Season,
                           "Madrid Bravos", "MB", 2024,
                           "Madrid Bravos", "MAD", 2025:present),
      ...
      "Centurions", tribble(~Team, ~Abb, ~Season,
                            "Cologne Centurions", "CC", 2021:2024,
                            "Cologne Centurions", "CCE", 2025:present),
                    tribble(~Conference, ~Season,
                            "Southern", 2022,
                            "Western", 2023:2024),
                    tribble(~Division, ~Season,
      ...
      "Enthroners", tribble(~Team, ~Abb, ~Season,
                            "Fehervar Enthroners", "FE", 2023:2024,
                            "Fehervar Enthroners", "ENT", 2025:present),
                    tribble(~Conference, ~Season,
                            "Eastern", 2023:2024),
                    tribble(~Division, ~Season,
                            "East", 2025:present),
...
### F G H I J ----
            "Fire", tribble(~Team, ~Abb, ~Season,
                            "Rhein Fire", "RF", 2022:2024,
                            "Rhein Fire", "RHF", 2025:present),
                    tribble(~Conference, ~Season,
                            "Southern", 2022,
                            "Western", 2023:2024),
                    tribble(~Division, ~Season,
          ...
          "Galaxy", tribble(~Team, ~Abb, ~Season,
                            "Frankfurt Galaxy", "FG", 2021:2024,
                            "Frankfurt Galaxy", "FGY", 2025:present),
                    tribble(~Conference, ~Season,
                            "Central", 2022,
                            "Western", 2023:2024),
                    tribble(~Division, ~Season,
...
### K L M N O ----
           ...
           "Lions", tribble(~Team, ~Abb, ~Season,
                            "Prague Lions", "PL", 2023:2024,
                            "Prague Lions", "PRG", 2025:present),
                    tribble(~Conference, ~Season,
                            "Eastern", 2023:2024),
                    tribble(~Division, ~Season,
                            "East", 2025:present),
                    tribble(~Stadium, ~Location, ~Gs, ~Lat, ~Long, ~Season,
                            ...
                            "Sportovní centrum Hhttps://europeanleague.football/games/250518-nordic-storm---helvetic-mercenariesostivař", "Prague, CZ", 1/6, 50.05058242731488, 14.547959192782962, 2023,
     ...
     "Mercenaries", tribble(~Team, ~Abb, ~Season,
                            "Helvetic Mercenaries", "HG", 2024,
                            "Helvetic Mercenaries", "HVM", 2025:present),
                    tribble(~Conference, ~Season,
                            "Central", 2024),
                    tribble(~Division, ~Season,
                            "South", 2025:present),
                    tribble(~Stadium, ~Location, ~Gs, ~Lat, ~Long, ~Season,
                            ...
                            "Sportzentrum Kleinfeld", "Kriens, CH", 1, 47.03, 8.288056, 2025:present),
      "Musketeers", tribble(~Team, ~Abb, ~Season,
                            "Paris Musketeers", "PM", 2023:2024,
                            "Paris Musketeers", "PAR", 2025:present),
                    tribble(~Conference, ~Season,
                            "Western", 2023:2024),
                    tribble(~Division, ~Season,
                            "West", 2025:present),
...
### P Q R S T ----
        "Panthers", tribble(~Team, ~Abb, ~Season,
                            "Panthers Wroclaw", "PW", 2021:2024,
                            "Panthers Wroclaw", "WPA", 2025:present),
                    tribble(~Conference, ~Season,
                            "Northern", 2022,
                            "Eastern", 2023:2024),
                    tribble(~Division, ~Season,
         ...
         "Raiders", tribble(~Team, ~Abb, ~Season,
                            "Raiders Tirol", "RT", 2022:2024,
                            "Raiders Tirol", "RAI", 2025:present),
                    tribble(~Conference, ~Season,
                            "Central", 2022:2024),
                    tribble(~Division, ~Season,
                            "South", 2025:present),
          ...
          "Ravens", tribble(~Team, ~Abb, ~Season,
                            "Munich Ravens", "MR", 2023:2024,
                            "Munich Ravens", "MUC", 2025:present),
                    tribble(~Conference, ~Season,
                            "Central", 2023:2024),
                    tribble(~Division, ~Season,
                            "South", 2025:present),
      ...
      "Sea Devils", tribble(~Team, ~Abb, ~Season,
                            "Hamburg Sea Devils", "HD", 2021:2024,
                            "Hamburg Sea Devils", "HSD", 2025:present),
                    tribble(~Conference, ~Season,
                            "Northern", 2022,
                            "Western", 2023:2024),
                    tribble(~Division, ~Season,
           ...
           "Surge", tribble(~Team, ~Abb, ~Season,
                            "Stuttgart Surge", "SS", 2021:2024,
                            "Stuttgart Surge", "SRG", 2025:present),
                    tribble(~Conference, ~Season,
                            "Central", 2022:2024),
                    tribble(~Division, ~Season,
                            "South", 2021,
         ...
         "Thunder", tribble(~Team, ~Abb, ~Season,
                            "Berlin Thunder", "BT", 2021:2024,
                            "Berlin Thunder", "BTH", 2025:present),
                    tribble(~Conference, ~Season,
                            "Northern", 2022,
                            "Eastern", 2023:2024),
                    tribble(~Division, ~Season,
...
### U V W X Y Z ----
         "Vikings", tribble(~Team, ~Abb, ~Season,
                            "Vienna Vikings", "VV", 2022:2024,
                            "Vienna Vikings", "VIK", 2025:present),
                    tribble(~Conference, ~Season,
                            "Central", 2022,
                            "Eastern", 2023:2024),
                    tribble(~Division, ~Season,
...
colors_elf <- list(
  Division = tribble(~Name, ~Color, ~Season,
                     "North", "#1f3f77", 2021,
                     "South", "#cd2028", 2021,
                     "East", "#dfdf39", 2025:present,
                     "North", "#1f3f77", 2025:present,
                     "South", "#ac162c", 2025:present,
                     "West", "#005030", 2025:present),
  Conference = tribble(~Name, ~Color, ~Season,
                       "Central", "#008000", 2022:2024,
                       "Northern", "#1f3f77", 2022,
                       "Southern", "#cd2028", 2022,
                       "Eastern", "#cd2028", 2023:2024,
                       "Western", "#1f3f77", 2023:2024)
)
