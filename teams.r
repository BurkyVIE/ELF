...
teamdata_elf <- tribble(~Franchise, ~Team, ~Conference, ~Division, ~HomeField,
  ### A B C D E ----                        
              "Bravos", tribble(~Team, ~Abb2, ~Abb3, ~Season,
                                "Madrid Bravos", "MB", "MAD", 2024:present),
          ...
          "Centurions", tribble(~Team, ~Abb2, ~Abb3, ~Season,
                                "Cologne Centurions", "CC", "CCE", 2021:present),
                        tribble(~Conference, ~Season,
                                "Southern", 2022,
                                "Western", 2023:2024),
                        tribble(~Division, ~Season,
             ...
             "Dragons", tribble(~Team, ~Abb2, ~Abb3, ~Season,
                                "Barcelona Dragons", "BD", "BDR", 2021:2024),
                        tribble(~Conference, ~Season,
                                "Southern", 2022,
                                "Central", 2023:2024),
                        tribble(~Division, ~Season,
          ...
          "Enthroners", tribble(~Team, ~Abb2, ~Abb3, ~Season,
                                "Fehervar Enthroners", "FE", "ENT", 2023:present),
                        tribble(~Conference, ~Season,
                                "Eastern", 2023:2024),
                        tribble(~Division, ~Season,
                                "East", 2025:present),
  ...
  ### F G H I J ----
                "Fire", tribble(~Team, ~Abb2, ~Abb3, ~Season,
                                "Rhein Fire", "RF", "RHF", 2022:present),
                        tribble(~Conference, ~Season,
                                "Southern", 2022,
                                "Western", 2023:2024),
                        tribble(~Division, ~Season,
              ...
              "Galaxy", tribble(~Team, ~Abb2, ~Abb3, ~Season,
                                "Frankfurt Galaxy", "FG", "FGY", 2021:present),
                        tribble(~Conference, ~Season,
                                "Central", 2022,
                                "Western", 2023:2024),
                        tribble(~Division, ~Season,
              ...
              "Guards", tribble(~Team, ~Abb2, ~Abb3, ~Season,
               ...
               "Kings", tribble(~Team, ~Abb2, ~Abb3, ~Season,
                                "Leipzig Kings", "LK", "LKG", 2021:2023),
                        tribble(~Conference, ~Season,
                                "Northern", 2022,
                                "Eastern", 2023:2023),
                        tribble(~Division, ~Season,
               ...
               "Lions", tribble(~Team, ~Abb2, ~Abb3, ~Season,
                                "Prague Lions", "PL", "PRG", 2023:present),
                        tribble(~Conference, ~Season,
                                "Eastern", 2023:2024),
                        tribble(~Division, ~Season,
                                "East", 2025:present),
         ...
         "Mercenaries", tribble(~Team, ~Abb2, ~Abb3, ~Season,
                                "Helvetic Mercenaries", "HG", "HVM", 2024:present),
                        tribble(~Conference, ~Season,
                                "Central", 2024),
                        tribble(~Division, ~Season,
                                "South", 2025:present),
          ...
          "Musketeers", tribble(~Team, ~Abb2, ~Abb3, ~Season,
                                "Paris Musketeers", "PM", "PAR", 2023:present),
                        tribble(~Conference, ~Season,
                                "Western", 2023:2024),
                        tribble(~Division, ~Season,
                                "West", 2025:present),
  ...
  ### P Q R S T ----
            "Panthers", tribble(~Team, ~Abb2, ~Abb3, ~Season,
                                "Panthers Wroclaw", "PW", "WPA", 2021:present),
                        tribble(~Conference, ~Season,
                                "Northern", 2022,
                                "Eastern", 2023:2024),
                        tribble(~Division, ~Season,
             ...
             "Raiders", tribble(~Team, ~Abb2, ~Abb3, ~Season,
                                "Raiders Tirol", "RT", "RAI", 2022:present),
                        tribble(~Conference, ~Season,
                                "Central", 2022:2024),
                        tribble(~Division, ~Season,
                                "South", 2025:present),
              ...
              "Ravens", tribble(~Team, ~Abb2, ~Abb3, ~Season,
                                "Munich Ravens", "MR", "MUC", 2023:present),
                        tribble(~Conference, ~Season,
                                "Central", 2023:2024),
                        tribble(~Division, ~Season,
                                "South", 2025:present),
              ...
              "Seamen", tribble(~Team, ~Abb2, ~Abb3, ~Season,
                                "Milano Seamen", "MS", "MIL", 2023:2024),
                        tribble(~Conference, ~Season,
                                "Central", 2023:2024),
                        tribble(~Division, ~Season,
                                NA, NA),
          ...
          "Sea Devils", tribble(~Team, ~Abb2, ~Abb3, ~Season,
                                "Hamburg Sea Devils", "HD", "HSD", 2021:present),
                        tribble(~Conference, ~Season,
                                "Northern", 2022,
                                "Western", 2023:2024),
                        tribble(~Division, ~Season,
               ...
               "Storm", tribble(~Team, ~Abb2, ~Abb3, ~Season,
                                "Nordic Storm", "NO", "NDS", 2025:present),
                        tribble(~Conference, ~Season,
                                NA, NA),
                        tribble(~Division, ~Season,
                                "North", 2025:present),
               ...
               "Surge", tribble(~Team, ~Abb2, ~Abb3, ~Season,
                                "Stuttgart Surge", "SS", "SRG", 2021:present),
                        tribble(~Conference, ~Season,
                                "Central", 2022:2024),
                        tribble(~Division, ~Season,
                                "South", 2021,
             ...
             "Thunder", tribble(~Team, ~Abb2, ~Abb3, ~Season,
                                "Berlin Thunder", "BT", "BTH", 2021:present),
                        tribble(~Conference, ~Season,
                                "Northern", 2022,
                                "Eastern", 2023:2024),
                        tribble(~Division, ~Season,
  ...
  ### U V W X Y Z ----
             "Vikings", tribble(~Team, ~Abb2, ~Abb3, ~Season,
                                "Vienna Vikings", "VV", "VIK", 2022:present),
                        tribble(~Conference, ~Season,
                                "Central", 2022,
                                "Eastern", 2023:2024),
                        tribble(~Division, ~Season,
