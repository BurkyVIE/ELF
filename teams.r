...
### A B C D E ----                        
         "Bravos", tribble(~Team, ~Abb, ~Season,
                   ...
                   tribble(~Conference, ~Season,
                           "Western", 2024:present),
                   tribble(~Division, ~Season,
                           NA, NA),
                   tribble(~Stadium, ~Location, ~Lat, ~Long, ~Season,
                           "Estadio Vallehermoso", "Madrid, ES", 40.441694, -3.71, 2024:present),
      "Centurions", tribble(~Team, ~Abb, ~Season,
         ...
         "Dragons", tribble(~Team, ~Abb, ~Season,
                    ...
                    tribble(~Stadium, ~Location, ~Lat, ~Long, ~Season,
                            ...
                            "Estadio Olímpico de Tarrasa", "Tarrasa, ES", 41.576133, 2.011142, 2023:present),
...
### F G H I J ----
          ...
          "Galaxy", tribble(~Team, ~Abb, ~Season,
                    ...
                    tribble(~Division, ~Season,
                            "South", 2021),
                    tribble(~Stadium, ~Location, ~Lat, ~Long, ~Season,
                            "PSD Bank Arena", "Frankfurt, DE", 50.128056, 8.723333, 2021:present),
          "Guards", tribble(~Team, ~Abb, ~Season,
                    ...
                    tribble(~Division, ~Season,
                            NA, NA),
                    tribble(~Stadium, ~Location, ~Lat, ~Long, ~Season,
                            "Lidl Arena", "Wil, CH", 47.458333, 9.037222, 2023),
### K L M N O ----
