...
### F G H I J ----
            "Fire", tribble(~Team, ~Season,
                    ...
                    tribble(~Division, ~Season,
                            NA, NA),
                    tribble(~Stadium, ~Location, ~Lat, ~Long, ~Season,
                            "MSV-Arena", "Düsseldorf, DE", 51.409033, 6.778664, 2022:present),
...
### U V W X Y Z ----
         "Vikings", tribble(~Team, ~Season,
                    ...
                    tribble(~Division, ~Season,
                            NA, NA),
                    tribble(~Stadium, ~Location, ~Lat, ~Long, ~Season,
                            "Generali Arena", "Vienna, AT", 48.162345, 16.387156, 2022:present),
          "Munich", tribble(~Team, ~Season,
                            "Munich tbd", 2023:present),
                    tribble(~Conference, ~Season,
                            "Expansion", 2023:present),
                    tribble(~Division, ~Season,
                            NA, NA),
